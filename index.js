...
app.get('/', (req, res) => {
    let companies = ["Aditya Birla Sun Life Mutual Fund", "Axis Mutual Fund", "BNP Paribas Mutual Fund",
        ...
        "Principal Mutual Fund", "Quantum Mutual Fund", "SBI Mutual Fund", "Shriram Mutual Fund",
        "Sundaram Mutual Fund", "Tata Mutual Fund", "Taurus Mutual Fund", "Trust Mutual Fund", "UTI Mutual Fund",
        "Union Mutual Fund", "YES Mutual Fund", "quant Mutual Fund", "Pearson Specter Litt", "Dunder Mifflin"
    ];
    let logos = ["AdityaBirla.png", "axis.jpg", "baroda.png", "bnpparibas.png", "boi axa.jpg", ""
